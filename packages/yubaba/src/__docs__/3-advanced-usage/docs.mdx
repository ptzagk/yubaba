...
Two examples of animations who can use it are [Move](/move), [Expand](/expand), and [ExpandMove](/expand-move).
      ...
      <Baba name={`card-${props.index}`}>
        <ConcealMove>
          {baba => (
            ...
            >
              <ListItem>
                <Typography variant="title">{Styled.data[props.index].title}</Typography>
                <IconButton
                  color="inherit"
                  aria-label="Menu"
              ...
              <ListItem>
                <Typography variant="body2">{Styled.data[props.index].body}</Typography>
              </ListItem>
            </Styled.Screen>
          )}
        </ConcealMove>
