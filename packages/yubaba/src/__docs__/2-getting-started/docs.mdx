...
> **Tip -** Press backspace to select another value.
...
> **Tip -** You may be thinking - but wait - why not just use regular CSS transitions for this?
> Well you're in luck - under the hood that's what `yubaba` is using!
> As an added bonus for using `yubaba` you get the powerful orchestration that is provided out-of-the-box.

## Moving to a another distinct element
...
> check out [Advanced usage](/advanced-usage#delay-showing-content-until-all-animations-have-finished) for more info!
